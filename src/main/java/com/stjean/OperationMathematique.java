...
public class OperationMathematique {
    ...
    public int factoriel(int nombre) throws IllegalParamISIException {
        if (nombre < 0) throw new IllegalParamISIException("Le factoriel d'un nombre négatif n'existe pas");
        int result = 1;
